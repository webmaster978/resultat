...
<label for="default" class="col-sm-2 control-label">Nom complet</label>
<div class="col-sm-10">
...
<div class="form-group">
<label for="default" class="col-sm-2 control-label">Matricule</label>
<div class="col-sm-10">
...
<div class="col-sm-10">
<input type="radio" name="gender" value="Masculin" required="required" checked="">Masculin <input type="radio" name="gender" value="Feminin" required="required">Feminin <input type="radio" name="gender" value="Other" required="required">Other
</div>
</div>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="default" class="col-sm-2 control-label">Classe</label>
                                                        <div class="col-sm-10">
 <select name="class" class="form-control" id="default" required="required">
<option value="">Selectionner la Class</option>
